...
public enum ErrorCode {
    ...
    QUANTITY_CANNOT_GREATER_THAN_FIVE(1002, "Quantity can't greater than five", HttpStatus.CONFLICT),
    ...
    INVALID_BORROW_DATE(1003,"Ngày mượn phải từ now, kết thúc sau ngày bắt đầu và không vượt quá 10 ngày.",HttpStatus.NOT_FOUND),
